...
include::chapters/dynamic-programming--intro.adoc[]

:leveloffset: +1

include::chapters/dynamic-programming--fibonacci.adoc[]
...
include::chapters/greedy-algorithms--intro.adoc[]

:leveloffset: +1

include::chapters/greedy-algorithms--knapsack-problem.adoc[]
